...
#danap
set(CMAKE_WIND_VX7_LLVM_HOST_TYPE $ENV{WIND_VX7_LLVM_HOST_TYPE})
#danap
...
# danap
elseif (${TOOL} MATCHES "llvm")
set(TOOL_PATH $ENV{WIND_LLVM_PATH}/${CMAKE_WIND_VX7_LLVM_HOST_TYPE}/bin)
set(WIND_LLVM_PATH $ENV{WIND_LLVM_PATH})
message(STATUS "WIND_ICC_PATH:    ${WIND_ICC_PATH}")
message(STATUS "WIND_LLVM_PATH:    ${WIND_LLVM_PATH}")
message(STATUS "CMAKE_WIND_VX7_LLVM_HOST_TYPE:    ${CMAKE_WIND_VX7_LLVM_HOST_TYPE}")
...
#	"sh -c '  -o <TARGET>.partial.o <OBJECTS> &&   <TARGET>.partial.o | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c arm -tags $(VSB_DIR)/krnl/tags/dkm.tags > <TARGET>.ctdt.c &&   -t7 -mfpu=vfp -mfloat-abi=softfp -Xdollar-in-ident -ei4177,4301,4550 -ei4177,4550,2273,5387,5388,1546,5849,1824 -ei4111,4171,4188,4191,4513,5457 -Xforce-declarations    -o <TARGET>.ctdt.o -c <TARGET>.ctdt.c && /dld -t7 -mfpu=vfp -mfloat-abi=softfp -X -r5  -o <TARGET> <TARGET>.partial.o <TARGET>.ctdt.o <LINK_LIBRARIES>    '")
	"sh -c '    <TARGET>.partial.o | tclsh $(WIND_BASE)/host/resource/hutils/tcl/munch.tcl -c arm -tags $(VSB_DIR)/krnl/tags/dkm.tags > <TARGET>.ctdt.c &&   -t7 -mfpu=vfp -mfloat-abi=softfp -Xdollar-in-ident -ei4177,4301,4550 -ei4177,4550,2273,5387,5388,1546,5849,1824 -ei4111,4171,4188,4191,4513,5457 -Xforce-declarations    -o <TARGET>.ctdt.o -c <TARGET>.ctdt.c && /dld -t7 -mfpu=vfp -mfloat-abi=softfp -X -r5  -o <TARGET> <TARGET>.partial.o <TARGET>.ctdt.o <LINK_LIBRARIES>    '")
endif()
